    ...
    public void singlePlayerMode() {
        ...
        th0.setOnMousePressed(event -> {
            if (table.emptyRow(0) != -1) {
                redPins[table.emptyRow(0)][0].setVisible(true);
                table.insertPin("red", table.emptyRow(0), 0);
                winner = table.winnerCheck("red", table.emptyRow(0) + 1, 0);
                ...
                int computerCol = computerMove.move(table.emptyRow(0) + 1, 0);
        ...
        th1.setOnMousePressed(event -> {
            if (table.emptyRow(1) != -1) {
                redPins[table.emptyRow(1)][1].setVisible(true);
                table.insertPin("red", table.emptyRow(1), 1);
                winner = table.winnerCheck("red", table.emptyRow(1) + 1, 1);
                if (winner.equals("red")) {
                    greyShade.setVisible(true);
                    menu.setVisible(true);
                    winnerText.setText("red" + "is winner!!!");
                ...
                int computerCol = computerMove.move(table.emptyRow(1) + 1, 1);
                yellowPins[table.emptyRow(computerCol) + 1][computerCol].setVisible(true);
                winner = table.winnerCheck("yellow", table.emptyRow(computerCol) + 1, computerCol);
                if (winner.equals("yellow")) {
                    greyShade.setVisible(true);
        ...
        th2.setOnMousePressed(event -> {
            if (table.emptyRow(2) != -1) {
                redPins[table.emptyRow(2)][2].setVisible(true);
                table.insertPin("red", table.emptyRow(2), 2);
                winner = table.winnerCheck("red", table.emptyRow(2) + 1, 2);
                if (winner.equals("red")) {
                    greyShade.setVisible(true);
                    menu.setVisible(true);
                    winnerText.setText("red" + "is winner!!!");
                ...
                int computerCol = computerMove.move(table.emptyRow(2) + 1, 2);
                yellowPins[table.emptyRow(computerCol) + 1][computerCol].setVisible(true);
                winner = table.winnerCheck("yellow", table.emptyRow(computerCol) + 1, computerCol);
                if (winner.equals("yellow")) {
                    greyShade.setVisible(true);
        ...
        th3.setOnMousePressed(event -> {
            if (table.emptyRow(3) != -1) {
                redPins[table.emptyRow(3)][3].setVisible(true);
                table.insertPin("red", table.emptyRow(3), 3);
                winner = table.winnerCheck("red", table.emptyRow(3) + 1, 3);
                if (winner.equals("red")) {
                    greyShade.setVisible(true);
                    menu.setVisible(true);
                    winnerText.setText("red" + "is winner!!!");
                ...
                int computerCol = computerMove.move(table.emptyRow(3) + 1, 3);
                yellowPins[table.emptyRow(computerCol) + 1][computerCol].setVisible(true);
                winner = table.winnerCheck("yellow", table.emptyRow(computerCol) + 1, computerCol);
                if (winner.equals("yellow")) {
                    greyShade.setVisible(true);
        ...
        th4.setOnMousePressed(event -> {
            if (table.emptyRow(4) != -1) {
                redPins[table.emptyRow(4)][4].setVisible(true);
                table.insertPin("red", table.emptyRow(4), 4);
                winner = table.winnerCheck("red", table.emptyRow(4) + 1, 4);
                if (winner.equals("red")) {
                    greyShade.setVisible(true);
                    menu.setVisible(true);
                    winnerText.setText("red" + "is winner!!!");
                ...
                int computerCol = computerMove.move(table.emptyRow(4) + 1, 4);
                yellowPins[table.emptyRow(computerCol) + 1][computerCol].setVisible(true);
                winner = table.winnerCheck("yellow", table.emptyRow(computerCol) + 1, computerCol);
                if (winner.equals("yellow")) {
                    greyShade.setVisible(true);
        ...
        th5.setOnMousePressed(event -> {
            if (table.emptyRow(5) != -1) {
                redPins[table.emptyRow(5)][5].setVisible(true);
                table.insertPin("red", table.emptyRow(5), 5);
                winner = table.winnerCheck("red", table.emptyRow(5) + 1, 5);
                if (winner.equals("red")) {
                    greyShade.setVisible(true);
                    menu.setVisible(true);
                    winnerText.setText("red" + "is winner!!!");
                ...
                int computerCol = computerMove.move(table.emptyRow(5) + 1, 5);
                yellowPins[table.emptyRow(computerCol) + 1][computerCol].setVisible(true);
                winner = table.winnerCheck("yellow", table.emptyRow(computerCol) + 1, computerCol);
                if (winner.equals("yellow")) {
                    greyShade.setVisible(true);
        ...
        th6.setOnMousePressed(event -> {
            if (table.emptyRow(6) != -1) {
                redPins[table.emptyRow(6)][6].setVisible(true);
                table.insertPin("red", table.emptyRow(6), 6);
                winner = table.winnerCheck("red", table.emptyRow(6) + 1, 6);
                if (winner.equals("red")) {
                    greyShade.setVisible(true);
                    menu.setVisible(true);
                    winnerText.setText("red" + "is winner!!!");
                ...
                int computerCol = computerMove.move(table.emptyRow(6) + 1, 6);
                yellowPins[table.emptyRow(computerCol) + 1][computerCol].setVisible(true);
                winner = table.winnerCheck("yellow", table.emptyRow(computerCol) + 1, computerCol);
                if (winner.equals("yellow")) {
                    greyShade.setVisible(true);
